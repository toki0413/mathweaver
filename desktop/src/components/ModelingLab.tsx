  ...
  return (
    <div className="ml-container">
      <style>{`
        ...
        .ml-btn.active { background: var(--accent, #d97757); border-color: var(--accent); color: #fff; }
        .ml-sidebar {
          width: 300px;
          flex-shrink: 0;
        ...
        .ml-model-btn:hover { border-color: var(--accent, #d97757); }
        .ml-model-btn.active {
