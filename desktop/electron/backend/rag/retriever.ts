...
function _additionalEntries(): KnowledgeEntry[] {
  return [
    createKnowledgeEntry('galois_theory', 'Galois Theory', [
    ...
    createKnowledgeEntry('erlangen_program', 'Erlangen Program', [
    ...
    createKnowledgeEntry('cayley_theorem', "Cayley's Theorem", [
    ...
    createKnowledgeEntry('abel_ruffini', 'Abel-Ruffini Theorem', [
    ...
    createKnowledgeEntry('normal_subgroup', 'Normal Subgroups', [
    ...
    createKnowledgeEntry('group_homomorphism', 'Group Homomorphisms', [
    ...
    createKnowledgeEntry('isomorphism_theorems', 'Isomorphism Theorems', [
    ...
    createKnowledgeEntry('symmetric_group', 'Symmetric Groups and Permutations', [
    ...
    createKnowledgeEntry('quotient_group', 'Quotient Groups', [
    ...
    createKnowledgeEntry('cyclic_group_detail', 'Cyclic Groups', [
    ...
    createKnowledgeEntry('ring_theory_intro', 'Introduction to Ring Theory', [
    ...
    createKnowledgeEntry('field_theory_intro', 'Introduction to Field Theory', [
    ...
    createKnowledgeEntry('vector_space_axioms', 'Vector Space Axioms', [
    ...
    createKnowledgeEntry('linear_independence', 'Linear Independence', [
    ...
    createKnowledgeEntry('basis_and_dimension', 'Basis and Dimension', [
    ...
    createKnowledgeEntry('eigenvalues', 'Eigenvalues and Eigenvectors', [
      ...
      keywords: ['eigenvalue', 'eigenvector', 'characteristic polynomial',
        'spectrum', 'diagonalizable', 'trace', 'determinant', 'PCA'],
      source: 'supplementary',
    }),
    createKnowledgeEntry('matrix_groups', 'Matrix Groups (Classical Groups)', [
    ...
    createKnowledgeEntry('group_action', 'Group Actions', [
      ...
      keywords: ['group action', 'orbit', 'stabilizer',
        'orbit-stabilizer', 'conjugation', 'Burnside', 'symmetry'],
      source: 'supplementary',
    }),
    createKnowledgeEntry('sylow_theorems', 'Sylow Theorems', [
    ...
    createKnowledgeEntry('dihedral_group', 'Dihedral Groups', [
    ...
    createKnowledgeEntry('group_representation', 'Group Representation Theory', [
    ...
    createKnowledgeEntry('lagrange_theorem_detail', "Lagrange's Theorem (Detailed)", [
    ...
    // --- 新数学运动与教育哲学 ---
    createKnowledgeEntry('new_math_movement', 'The New Math Movement (1958-1975)', [
    ...
    createKnowledgeEntry('bourbaki_influence', "Bourbaki's Influence on Mathematics Education", [
    ...
    createKnowledgeEntry('morris_kline_critique', "Morris Kline's Critique: Why Johnny Can't Add", [
    ...
    createKnowledgeEntry('mathweaver_new_math_response', "MathWeaver's Response to the New Math Legacy", [
...
export function buildDefaultKB(): KnowledgeBase {
  ...
  console.info(`[RAG] Built default knowledge base with ${kb.size} entries`)
  return kb
}
